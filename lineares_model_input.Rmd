...
mod7 <- lm(Gesamtumsatz ~ Ware_1 + Ware_2 + Ware_3 + Ware_4 + Ware_5 + Ware_6 + as.factor(Temperaturklassen) + as.factor(Wettercode), master_df) 
...
```
```{r}
modx <- lm(Gesamtumsatz ~ Ware_2 + Ware_3 + Ware_4 + Ware_5 + Ware_6, master_df)
summary(modx)
```
