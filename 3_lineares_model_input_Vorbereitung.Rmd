...
#Weitere Änderungen von Tobias. Grund: Der Fehler mit den fehlenden Umsätzen zur KiWo kommt zustande, da beim Berechnen des Gesamtumsatzes etwas falsch läuft. An Tagen an denen Ware_6 null ist ist der Gesamtumsatz auch null, obwohl andere Warengruppen Umsatz gemacht haben. Den Programmcode kann ich allerdings nicht finden.Den hat Katha vermutlich vergessen zu teilen. NA Werte durch 0 ersetzt und Gesamtzumsatz neu berechnet. Hat geklappt.
