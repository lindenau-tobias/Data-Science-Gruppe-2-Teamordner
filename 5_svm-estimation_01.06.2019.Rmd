...
mod2 <- lm(Ware_1 ~ as.factor(Wochentag) + as.factor(Wettercode), train)
mod3 <- lm(Ware_1 ~ as.factor(Wochentag) + as.factor(Temperaturklassen), train)
mod4 <- lm(Ware_1 ~ as.factor(Wochentag) + as.factor(Temperaturklassen) + as.factor(nach_feiertag), train)
mod5 <- lm(Ware_1 ~ as.factor(Wochentag) + as.factor(Temperaturklassen) + as.factor(Ferien), train)
mod6 <- lm(Ware_1 ~ as.factor(Wochentag) + as.factor(Temperaturklassen) + as.factor(Ferien) + as.factor(KielerWoche), train)
mod7 <- lm(Ware_1 ~ as.factor(Wochentag) + as.factor(Temperaturklassen) + as.factor(Ferien) + as.factor(KielerWoche) + as.factor(Weihnachtsmarkt), train)
