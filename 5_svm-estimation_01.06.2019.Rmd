...
```{r}
#Ware_1 Umsätze
mod1 <- lm(Ware_1 ~ as.factor(Wochentag), train)
mod2 <- lm(Ware_1 ~ as.factor(Wochentag) + Wettercode, train)
mod3 <- lm(Ware_1 ~ as.factor(Wochentag) + Wettercode + as.factor(Temperaturklassen), train)
mod4 <- lm(Ware_1 ~ as.factor(Wochentag) + Wettercode + as.factor(Temperaturklassen) + as.factor(nach_feiertag), train)
mod5 <- lm(Ware_1 ~ as.factor(Wochentag) + Wettercode + as.factor(Temperaturklassen) + as.factor(nach_feiertag) + as.factor(Ferien), train)
mod6 <- lm(Ware_1 ~ as.factor(Wochentag) + Wettercode + as.factor(Temperaturklassen) + as.factor(nach_feiertag) + as.factor(Ferien) + as.factor(KielerWoche), train)
mod7 <- lm(Ware_1 ~ as.factor(Wochentag) + Wettercode + as.factor(Temperaturklassen) + as.factor(nach_feiertag) + as.factor(Ferien) + as.factor(KielerWoche) + as.factor(Weihnachtsmarkt), train)
...
rmse_models <- rbind(rmse(train$Gesamtumsatz, predict(mod1)),
                     ...
                     rmse(train$Gesamtumsatz, predict(mod3)), 
...
rmse_models_test <- rbind(rmse(test$Gesamtumsatz, predict(mod1, newdata = test)),
                          ...
                          rmse(test$Gesamtumsatz, predict(mod4, newdata = test)),
                          rmse(test$Gesamtumsatz, predict(mod5, newdata = test)),
                          rmse(test$Gesamtumsatz, predict(mod6, newdata = test)),
                          rmse(test$Gesamtumsatz, predict(mod7, newdata = test))) 
...
mod5_pred <- predict(mod4, newdata = test)
mod6_pred <- predict(mod4, newdata = test)
mod7_pred <- predict(mod4, newdata = test)

scatter_input_lm <- test %>%
  select(Ware_1, Wochentag) %>%
...
ggplot(data = scatter_input_lm, aes(x=Ware_1, y=mod1, color = Wochentag))+
  geom_point()+
...
mod5 <- lm(Gesamtumsatz ~ Ware_1 + Ware_2 + Ware_3 + Ware_4 + Ware_5 + Ware_6 + as.factor(Wochentag) + as.factor(Wettercode) + as.factor(Temperaturklassen), train)
mod6 <- lm(Gesamtumsatz ~ Ware_1 + Ware_2 + Ware_3 + Ware_4 + Ware_5 + Ware_6 + as.factor(Wochentag) + as.factor(Temperaturklassen) + as.factor(nach_feiertag) + as.factor(Ferien), train)
mod7 <- lm(Gesamtumsatz ~ as.factor(Wochentag), train)
